#pragma once
/**
 * PC stub for dolphin/card.h
 * All structs, macros, and function declarations are kept identical to the
 * original so existing game code compiles unchanged.
 *
 * On PC the card channels map to save-files in the user data directory.
 * The full implementation lives in src/dolphin/card.cpp.
 * Only a few trivially-answerable queries are inlined here.
 */
...
// Animation flags (stored in bannerFormat byte)
...
// ---------------------------------------------------------------------------
// Accessor macros (identical to original)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Frequency selection (kept for source compat; value unused on PC)
// ---------------------------------------------------------------------------
...
// The async variants invoke the callback from src/dolphin/card.cpp.
// ---------------------------------------------------------------------------

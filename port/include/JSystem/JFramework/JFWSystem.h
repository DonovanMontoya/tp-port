#pragma once
/**
 * port/include/JSystem/JFramework/JFWSystem.h
 * PC port shadow of JFWSystem.
 * firstInit() and init() are no-ops; heap accessors return sSystemHeap.
 */
...
struct JFWSystem {
    ...
    static void setRenderMode(const GXRenderModeObj* modeObj) {
        JUT_ASSERT(80, sInitCalled == FALSE);
        CSetUpParam::renderMode = modeObj;
    }
